...
3. Search by Category
   Enter a category (e.g., Food or Transport) to view only expenses under that category and see the total spent.
...
📦 Requirements:
No external libraries needed. Works with standard Python 3.
